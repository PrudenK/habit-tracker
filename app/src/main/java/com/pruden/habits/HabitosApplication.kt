...
class HabitosApplication : Application(){
    ...
    val MIGRATION_12_13 = object : Migration(12, 13) {
        override fun migrate(database: SupportSQLiteDatabase) {
            database.execSQL("ALTER TABLE Habitos ADD COLUMN objetivoSemanal INTEGER NOT NULL DEFAULT -1")
            database.execSQL("ALTER TABLE Habitos ADD COLUMN objetivoMensual TEXT NOT NULL DEFAULT '-1@-1@-1@-1'")
            database.execSQL("ALTER TABLE Habitos ADD COLUMN objetivoAnual TEXT NOT NULL DEFAULT '-1@-1'")
        }
    }

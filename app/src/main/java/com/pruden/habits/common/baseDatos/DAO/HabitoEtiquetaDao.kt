...
interface HabitoEtiquetaDao {
    ...
    @Query(value = "SELECT * FROM Habitos INNER JOIN HabitoEtiqueta ON Habitos.nombre = HabitoEtiqueta.nombreHabito WHERE HabitoEtiqueta.nombreEtiqueta = :nombreEtiqueta")
